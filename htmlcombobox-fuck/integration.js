        ...
        setFormSubmitHandler(handler) {
            ...
            this.form.addEventListener('submit', this.formSubmitHandler);
                ...
                #initializeFormIntegration() {
                    ...
                    // Create and configure hidden input
                    const hiddenInput = document.createElement('input');
                    hiddenInput.type = 'hidden';
                    hiddenInput.name = this.getAttribute('name') || 'comboInput';
                    form.appendChild(hiddenInput);
        
                    // Sync function to update hidden input value
                    const syncValue = () => {
                        hiddenInput.value = this.getAttribute('data-value') || this.state?.value || '';
                    };
        
                    // Event listeners for value synchronization
                    this.addEventListener('input-changed', syncValue);
                    this.addEventListener('selection-changed', syncValue);
